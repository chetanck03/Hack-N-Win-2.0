...
import Reset from "../../components/ElectionCommission/Reset";
import ChangeElectionCommission from "../../components/ElectionCommission/ChangeElectionCommission";
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center px-4 py-8">
      <div className="max-w-4xl w-full space-y-8">
        ...
        {/* Reset Voting System */}
        <section className="p-6 bg-gray-800 rounded-lg shadow-lg">
          <h2 className="text-2xl font-semibold text-blue-400 mb-4">Reset Voting System</h2>
          <Reset/>
        </section>
       
        <section className="p-6 bg-gray-800 rounded-lg shadow-lg">
          <h2 className="text-2xl font-semibold text-blue-400 mb-4">Change Election Commission</h2>
          <ChangeElectionCommission/>
        </section>
      </div>
    </div>
  );
